...
# Train and log
with open("results/elogs.csv", mode="w", newline="") as file:
...
# Save trained model
import pickle
with open("results/emodel.pkl", "wb") as f:
    pickle.dump(model, f)
print("\nModel saved to emodel.pkl")  # noqa: T201
...
with open("results/emodel.pkl", "rb") as f:
    model = pickle.load(f)
